...
const Hero = () => {
  return (
    <section className="w-full">
      ...
      <div className="container pt-25 mx-auto flex h-[425px] justify-between flex-col items-center gap-4 px-4 py-12 transition-all md:h-[50dvh] md:justify-center lg:h-[80dvh] lg:px-0">
